...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        sendNotification: function sendNotification() {
            ...
            Nova.request().post('/nova-vendor/notifier/send', this.payload, this.formConfig).then(function (response) {
                if (response.data.status == 'success') {
                    _this.$toasted.show('Notification Sent', { type: 'success' });
                }
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Injaz Notifier")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          _c("div", { staticClass: "flex border-40" }, [
            _c("div", { staticClass: " px-8 py-6 width-100 text-center" }, [
              _c(
                "label",
                {
            ...
            _vm._v(" "),
            _c("div", { staticClass: "py-6 px-8 width-350" }, [
              _c(
                "select",
                {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.payload.to,
                      expression: "payload.to"
                    }
                  ],
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("option", { attrs: { value: "AllStudents" } }, [
                    _vm._v("All Students")
                  ]),
                  _vm._v(" "),
                  _c("option", { attrs: { value: "AllMentors" } }, [
                    _vm._v("All Mentors")
                  ])
                ]
              )
          ...
          _vm._v(" "),
          _c("div", { staticClass: "flex border-40" }, [
            _c("div", { staticClass: "width-100 text-center px-8 py-6" }, [
              _c(
                "label",
                {
                  staticClass: "inline-block text-80 pt-2 leading-tight",
            ...
            _c("div", { staticClass: "py-6 px-8 width-350" }, [
              ...
              _vm._v(" "),
              _c("span", {
                staticClass: "help-text help-text mt-2 text-danger"
              })
            ])
          ]),
          _vm._v(" "),
              ...
              _c("div", { staticClass: "py-6 px-8 width-350" }, [
                _c("div", { staticClass: "flex items-center" }, [
                  _c("textarea", {
                    ...
                    domProps: { value: _vm.payload.body },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.payload, "body", $event.target.value)
                      }
                    }
                  })
                ]),
          ...
          _vm._v(" "),
          _c("div", { staticClass: "flex border-b border-40 items-center" }, [
            _c("div", { staticClass: "py-6 px-3 " }, [
              _c(
                "button",
                {
                  staticClass: "btn btn-default btn-primary  width-200",
                  attrs: { type: "button" },
                  on: {
