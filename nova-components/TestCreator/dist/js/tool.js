...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_flatpickr_component__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_flatpickr_dist_flatpickr_css__ = __webpack_require__(22);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        updateAnswersList: function updateAnswersList(e) {
        ...
        addQuestions: function addQuestions(index) {
        ...
        calculateMarks: function calculateMarks() {
            var total = 0;
        ...
        addAnswers: function addAnswers(question, index) {
        ...
        removeAnswers: function removeAnswers(question, index) {
        ...
        addQuestion: function addQuestion(question) {
            ...
            if (question.type == 'MCQ') if (question.answers.length > 0) question.answers.forEach(function (answer, index) {
                if (answer.answer == null || answer.answer == '') {
                    _this.errors.answers = 'All Answer fields are required';
                }
            });else this.errors.answers = 'Answer field is required';
        ...
        editQQuestion: function editQQuestion(question) {
            // console.log(question);
            this.errors = {};
        ...
        updateQuestion: function updateQuestion() {
            ...
            if (this.editQuestion.type == 'MCQ') if (this.editQuestion.answers.length > 0) this.editQuestion.answers.forEach(function (answer, index) {
                if (answer.answer == null || answer.answer == '') {
                    _this2.errors.answers = 'All Answer fields are required';
                }
            });else this.errors.answers = 'Answer field is required';
            ...
            this.questions.forEach(function (question, index) {
                if (question.order_number == _this2.editQuestion.order_number) {
                    _this2.questions[index] = _this2.editQuestion;
                }
            });
        ...
        createTest: function createTest() {
            ...
            this.payload.questions = this.questions.map(function (el) {

                if (el.type == 'MCQ') return {
                    question: el.question,
                    correct_answer: el.correct_answer,
                    order_number: el.order_number,
                    marks: el.marks,
                    type: el.type,
                    answers: el.answers.map(function (ans) {
                        return {
                            answer: ans.answer,
                            order_number: ans.order_number
                        };
                    })
                };else if (el.type == 'TEXT') return {
                    question: el.question,
                    correct_answer: 0,
                    order_number: el.order_number,
                    marks: el.marks,
            ...
            Nova.request().post('/nova-vendor/test-creator/create', this.payload, this.formConfig).then(function (response) {
                if (response.data.status == 'success') window.location.replace('/dashboard/resources/tests/' + response.data.data);
                ...
                if (error.response) {
                    if (error.response.status == 422) {
                        ...
                        if (Object.keys(_this3.errors).length == 1) {
                            _this3.$toasted.show(_this3.errors.message, { type: 'error' });
                        } else _this3.$toasted.show('Some Fields are missing', { type: 'error' });
                    }
        ...
        updateTest: function updateTest() {
            ...
            Nova.request().post('/nova-vendor/test-creator/update/' + this.testId, this.payload, this.formConfig).then(function (response) {
                if (response.data.status == 'success') window.location.replace('/dashboard/resources/tests/' + response.data.data);
            }).catch(function (error) {
                ...
                if (error.response) {
                    if (error.response.status == 422) {
                        ...
                        _this4.$toasted.show('Some fields may be invalid or file size may be too large', { type: 'error' });
                    } else {
                        _this4.$toasted.show('Server Error', { type: 'error' });
                    }
                } else if (error.request) {
                    console.log('request:', error.request);
                    _this4.$toasted.show('Server not responding', { type: 'error' });
                } else {
                    console.log('else Error', error.message);
                    _this4.$toasted.show(error.message || 'Error in request, please contact to support', { type: 'error' });
                }
            });
        },
        ...
        init: function init() {
            ...
            Nova.request().post('/nova-vendor/test-creator/init', {
                ...
                if (response.data.test) {
                    _this5.populateForm(response.data.test);
                }
            }).catch(function (error) {
                console.log(error);
                ...
                if (error.response) {
                    if (error.response.status === 422) {
                        ...
                        _this5.$toasted.show('Some fields may be missing or invalid', { type: 'error' });
                    } else if (error.response.status == 413) {
                        _this5.$toasted.show('Some fields may be invalid or file size may be too large', { type: 'error' });
                    } else {
                        _this5.$toasted.show('Server Error', { type: 'error' });
                    }
                } else if (error.request) {
                    console.log('request:', error.request);
                    _this5.$toasted.show('Server not responding', { type: 'error' });
                } else {
                    console.log('else Error', error.message);
                    _this5.$toasted.show(error.message || 'Error in request, please contact to support', { type: 'error' });
                }
            });
        },

        populateForm: function populateForm(test) {
            console.log(test.program);
            if (!this.duplicatetest) this.updatetest = true;
            this.payload = {
                'title': test.title,
            ...
            if (test.program != undefined) this.programs.unshift({ id: test.program.id, title: test.program.title });

            this.questions = test.test_questions.map(function (el) {
                //     return {
                //     question: el.question,
                //     correct_answer: el.correct_answer,
                //     order_number: el.order_number,
                ...
                if (el.question_type == 'MCQ') return {
                    question: el.question,
                    correct_answer: el.correct_answer,
                    order_number: el.order_number,
                    marks: el.marks,
                    type: el.question_type,
                    answers: el.question_answers.map(function (ans) {
                        return {
                            answer: ans.answer,
                            order_number: ans.order_number
                        };
                    })
                };else if (el.question_type == 'TEXT') return {
                    question: el.question,
                    correct_answer: 0,
                    order_number: el.order_number,
                    marks: el.marks,
        ...
        loadPrograms: function loadPrograms() {
            ...
            Nova.request().get('/nova-vendor/test-creator/programs').then(function (response) {

                _this6.programs = _this6.programs.concat(response.data.map(function (el) {
                    return {
                        id: el.id,
                        title: el.title
                    };
                }));
                console.log(_this6.programs);
                if (_this6.programs.length == 0 && !_this6.testId) _this6.noPrograms = true;else _this6.noPrograms = false;
            });
        },

        changeCorrectAnswer: function changeCorrectAnswer(index) {
            console.log(index);
            this.clearError('questions.' + index + '.correct_answer');
        },
        hasSubError: function hasSubError(field) {
            //console.log(field);
            if (field == 'answers') {
        ...
        getError: function getError(field) {
            var translate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_dom__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_dates__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_formatting__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_polyfills__ = __webpack_require__(21);
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Create Evaluation")]),
      _vm._v(" "),
      !_vm.noPrograms
        ? _c(
            "form",
            {
              ...
              on: {
                submit: function($event) {
                  ...
                  return _vm.createTest.apply(null, arguments)
                }
              }
            },
            [
                      ...
                      [
                        _c("div", { staticClass: "flex items-center" }, [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.payload.totalMarks,
                                expression: "payload.totalMarks"
                              }
                            ],
                            staticClass:
                              "text-center w-full form-control form-input form-input-bordered",
                            attrs: {
                              list: "title-list",
                              type: "text",
                            ...
                            domProps: { value: _vm.payload.totalMarks },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                ...
                _c("div", { staticClass: "flex border-b border-40" }, [
                  _c("div", { staticClass: "flex " }, [
                    ...
                    _c(
                      "div",
                      {
                        staticClass: "py-6 px-8 w-1/2 text-left",
                        staticStyle: { "padding-top": "30px", width: "450px" }
                      },
                      [
                        _c(
                          "select",
                          {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.payload.programId,
                                expression: "payload.programId"
                              }
                            ],
                            ...
                            on: {
                              change: [
                                ...
                                function($event) {
                                  return _vm.clearError("programId")
                                }
                              ]
                            }
                          },
                        ...
                        _vm._v(" "),
                        _vm.hasError("programId")
                          ? _c("span", {
                              staticClass:
                                "help-text help-text mt-2 text-danger",
                              domProps: {
                                textContent: _vm._s(_vm.getError("programId"))
                              }
                            })
                          : _vm._e()
                      ]
                      ...
                      [
                        _c("div", { staticClass: "flex items-center" }, [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.payload.passingMarks,
                                expression: "payload.passingMarks"
                              }
                            ],
                            staticClass:
                              "text-center w-full form-control form-input form-input-bordered",
                            ...
                            domProps: { value: _vm.payload.passingMarks },
                            on: {
                              change: function($event) {
                                return _vm.clearError("passingMarks")
                              },
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                        ...
                        _vm._v(" "),
                        _vm.hasError("passingMarks")
                          ? _c("span", {
                              staticClass:
                                "help-text help-text mt-2 text-danger",
                              domProps: {
                                textContent: _vm._s(
                                  _vm.getError("passingMarks")
                                )
                              }
                            })
                          : _vm._e()
              ...
              _c("div", { staticClass: "card" }, [
                _c(
                  ...
                  [
                    _c(
                      "div",
                      {
                        staticClass: "flex flex-wrap -mb-4 course-content-list",
                        staticStyle: {
                          "padding-right": "20px",
                          "padding-left": "20px",
                          "margin-top": "20px"
                      ...
                      [
                        _c(
                          ...
                          [
                            _c("div", { staticClass: "custom-border-left" }, [
                              _c(
                                "h3",
                                {
                                        ...
                                        [
                                          ...
                                          _c(
                                            "button",
                                            {
                                              ...
                                              refInFor: true,
                                              staticClass:
                                                "btn btn-primary pull-left chapter-content-Delete btn-content-delete",
                                              on: {
                                                click: function($event) {
                                                  $event.preventDefault()
                                                  return _vm.removeQuestions(
                                                    index
                                                  )
                                                }
                                              }
                                          ...
                                          _c(
                                            ...
                                            {
                                              staticClass:
                                                "btn btn-sm btn-danger pull-left chapter-content-Delete",
                                              staticStyle: {
                                                cursor: "pointer"
                                              },
                                              on: {
                ...
                _vm.questions.length > 0
                  ? _c("div", { staticClass: "flex questions" }, [
                          ...
                          _c(
                            "button",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  $event.preventDefault()
                                  return _vm.addQuestions(
                                    _vm.questions.length - 1 + 1
                                  )
                                }
                              }
                            },
              ...
              _vm.showModal
                ? [
                                        ...
                                        ? _c(
                                            ...
                                            [
                                              _c(
                                                ...
                                                {
                                                  on: {
                                                    end: _vm.updateAnswersList
                                                  },
                                                  model: {
                                                    value:
                                                      _vm.editQuestion.answers,
                                                    callback: function($$v) {
                                                      _vm.$set(
                                                        _vm.editQuestion,
                                                        "answers",
                                                                ...
                                                                _c(
                                                                  ...
                                                                  [
                                                                    _c(
                                                                      ...
                                                                      {
                                                                        staticClass:
                                                                          "btn btn-info custom-btn-success",
                                                                        staticStyle: {
                                                                          height:
                                                                            "20px",
                                                                          "margin-top":
                                                                        ...
                                                                        on: {
                                                                          change: [
                                                                            ...
                                                                            function(
                                                                              ...
                                                                              return _vm.changeCorrectAnswer(
                                                                                _vm.index
                                                                              )
                                                                            }
                                                                          ]
                                                  ...
                                                  _c(
                                                    ...
                                                    [
                                                      ...
                                                      _c(
                                                        ...
                                                        {
                                                          staticClass:
                                                            "btn btn-warning custom-btn-warning",
                                                          on: {
                                                            click: function(
                                                              $event
                                                            ) {
                                                              $event.preventDefault()
                                                              return _vm.addAnswers(
                                                                _vm.editQuestion,
                                                                _vm.editQuestion
                                                                  .answers
                                                                  .length -
                    ...
                    _vm._v(" "),
                    _c("div", {
                      staticClass: "fixed pin bg-80 z-20 opacity-75"
                    })
                  ]
                : _vm._e(),
              _vm._v(" "),
                                          ...
                                          !_vm.isSpinner
                                            ? _c(
                                                "button",
                                                {
                                                  staticClass:
                                                    "btn btn-default btn-primary",
                                                  attrs: { id: "e-add-record" },
                                                  on: {
                                                    click: function($event) {
                                                      $event.preventDefault()
                                                      return _vm.updateQuestion.apply(
                                                        null,
                                                        arguments
                                                      )
                                                    }
              ...
              _c("div", { staticClass: "flex items-center mt-4" }, [
                ...
                _c(
                  ...
                  [
                    !_vm.updatetest && !_vm.duplicatetest
                      ? _c("span", {}, [
                          _vm._v(
                            "\n                    Create\n                "
                          )
      ...
      _vm.noPrograms
        ? _c(
            ...
            {
              staticClass: "row",
              staticStyle: { display: "flex", "margin-top": "70px" }
            },
            [
              _c(
                "h1",
                {
                  staticClass: "mr-3 text-base text-80 font-bold m-8 mt-4",
                  staticStyle: {
                    margin: "0 auto",
                    "font-size": "70px",
                    "margin-bottom": "60px"
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: " px-8 py-6", staticStyle: { width: "150px" } },
      [
        _c(
          "label",
          {
  ...
  function() {
    ...
    return _c(
      "div",
      { staticClass: "py-6 px-8 text-left", staticStyle: { width: "150px" } },
      [
        _c(
          "label",
          { staticClass: "inline-block text-80 pt-2 leading-tight" },
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "w-1/5 py-6 px-8 text-left" }, [
