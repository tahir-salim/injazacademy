...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue2_timepicker_src_vue_timepicker_vue__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue2_timepicker_src_vue_timepicker_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_vue2_timepicker_src_vue_timepicker_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        ...
        VueTimepicker: __WEBPACK_IMPORTED_MODULE_4_vue2_timepicker_src_vue_timepicker_vue___default.a
        // Edit,
    },
    data: function data() {
        return {
    ...
    methods: {
        ...
        getCourseDetail: function getCourseDetail() {
            ...
            Nova.request().get('/nova-vendor/content-manager/program/' + this.course_id).then(function (response) {
                console.log(response);
                _this.courseTitle = response.data.detail.title;
                _this.chapters = response.data.detail.chapter;
                ...
                console.log(response);
                if (_this.chapters.length < 1) _this.chapterNotFound = true;
            });
        },

        // open edit content modal
        editContent: function editContent(content, type) {
        ...
        deleteCourseContent: function deleteCourseContent(data) {
            var _this2 = this;
            ...
            __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default.a.fire({
                ...
                if (result.value) {
                    ...
                    Nova.request().get('/nova-vendor/content-manager/delete-content/' + data.id + '/type/' + contentType).then(function (response) {
                        if (response.data.result) {
                            __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default.a.fire('Deleted!', 'Your file has been deleted.', 'success');
        ...
        addNew: function addNew(chapter, type) {
        ...
        updateList: function updateList(e) {
            ...
            Nova.request().post('/nova-vendor/content-manager/update-drag-drop-detail', {
                ...
                if (response) {
                    _this3.getCourseDetail();
                    _this3.$toasted.show('Program contents has been updated', { type: 'success' });
                }
            });
        },
        ...
        // form store method
        storeContent: function storeContent(evt) {
            var _this4 = this;
            ...
            if (this.editChapterContent.type === "FILE") {
                ...
                axios.post('/nova-vendor/content-manager/add-attachment', data, config).then(function (response) {
                    if (response) {
                        // this.isSpinner = false;
                        _this4.showModal = false;
                        _this4.$toasted.show('Program content has been updated', { type: 'success' });
                        _this4.getCourseDetail();
                    }
                    ...
                    if (error.response) {
                        ...
                        if (error.response.status === 422) {
                            ...
                            _this4.$toasted.show('Some Fields are missing', { type: 'error' });
                ...
                Nova.request().post('/nova-vendor/content-manager/add-video', {
                    ...
                    if (response) {
                        ...
                        _this4.isSpinner = false;
                        _this4.showModal = false;
                        _this4.$toasted.show('Record has been Inserted!', { type: 'success' });
                        _this4.getCourseDetail();
                    }
                }).catch(function (error) {
                    _this4.isSpinner = false;
        ...
        updateContent: function updateContent(e) {
            ...
            if (this.editChapterContent.type === "FILE") {
                ...
                // this.isSpinner = true;
                var config = { headers: { 'Content-Type': 'multipart/form-data' } };
                axios.post('/nova-vendor/content-manager/update-attachment', data, config).then(function (response) {
                    if (response) {
                        console.log(response);
                        _this5.isSpinner = false;
                        _this5.showEditModal = false;
                        _this5.$toasted.show('Program content has been updated', { type: 'success' });
                        _this5.getCourseDetail();
                    }
                }).catch(function (error) {
                    _this5.isSpinner = false;
                    if (error.response) {
                        ...
                        if (error.response.status === 422) {
                            ...
                            _this5.$toasted.show('Some Fields are missing', { type: 'error' });
                        } else if (error.response.status === 413) {
                ...
                Nova.request().post('/nova-vendor/content-manager/update-video', {
                    ...
                    if (response) {
                        ...
                        _this5.isSpinner = false;
                        _this5.showEditModal = false;
                        _this5.$toasted.show('Record has been Inserted!', { type: 'success' });
                        _this5.getCourseDetail();
                    }
                }).catch(function (error) {
                    _this5.isSpinner = false;
        ...
        deleteFile: function deleteFile(id) {
            ...
            Nova.request().get('/nova-vendor/content-manager/delete/' + id).then(function (response) {
                console.log(response);
                _this6.editChapterContent.data = "";
                _this6.editChapterContent.file_name = null;
                console.log(_this6.editChapterContent);
                // this.getCourseDetail();
            });
        },
        hasError: function hasError(index) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("e8ada69c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
      ...
      this.opts.hourRange.forEach(function (value) {
        if (value instanceof Array) {
          if (value.length > 2 && _this2.debugMode) {
            _this2.debugLog('Nested array within "hour-range" must contain no more than two items. Only the first two items of ' + JSON.stringify(value) + ' will be taken into account.');
          }
      ...
      if (this.restrictedHourRange) {
        ...
        if (this.baseOn12Hours) {
          list = this.restrictedHourRange.map(function (hr) {
            ...
            var r = hr.substr(-1);
            return '' + _this3.formatValue(_this3.hourType, l) + r;
          });
      ...
      rawRange.forEach(function (value) {
        if (value instanceof Array) {
          if (value.length > 2 && _this10.debugMode) {
            _this10.debugLog('Nested array within "' + section + '-range" must contain no more than two items. Only the first two items of ' + JSON.stringify(value) + ' will be taken into account.');
          }
          var start = value[0];
          var end = value[1] || value[0];
          for (var i = +start; i <= +end; i++) {
    ...
    getClosestHourItem: function getClosestHourItem(currentValue) {
      ...
      var currentIndex = this.validHoursList.findIndex(function (item) {
        if (!_this18.baseOn12Hours) {
          ...
          var valueKey = '' + currentValue + (_this18.lowerCasedApm(_this18.apm) === 'pm' ? 'p' : 'a');
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("div", { staticClass: "row course-detail-section" }, [
            _c("div", { staticClass: "mb-12" }, [
              _c(
                ...
                [
                  _c("h3", { staticClass: "mr-3 text-80 font-bold" }, [
                    _c("i", { staticClass: "fa fa-video" }),
                    _vm._v(" Manage Program - " + _vm._s(_vm.courseTitle))
                  ]),
                  _vm._v(" "),
                  _c("div", [
                    _c(
                    ...
                    _c(
                      "a",
                      {
                        ...
                        attrs: {
                          href:
                            "/dashboard/manage-chapter/" +
                            _vm.course_id +
                            "/" +
                            _vm.courseTitle
                        }
                      },
                      [_vm._v("Manage Sessions")]
                    )
                  ])
                ]
              ),
                ...
                ? _c(
                    ...
                    [
                      _c(
                        ...
                        {
                          staticClass:
                            "mr-3 text-base text-80 font-bold m-8 mt-4",
                          staticStyle: {
                            margin: "0 auto",
                            "font-size": "70px",
                            "margin-bottom": "60px"
                      ...
                      return _c(
                        ...
                        [
                          _c(
                            "div",
                            {
                              staticClass: "custom-border-left",
                              staticStyle: {
                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    ...
                                    {
                                      attrs: {
                                        options: { group: "chapter.contents" }
                                      },
                                      on: { end: _vm.updateList },
                                      model: {
                                        value: _vm.chapters[index].contents,
                                        callback: function($$v) {
                                          _vm.$set(
                                            _vm.chapters[index],
                                            "contents",
                                        ...
                                        expression: "chapters[index].contents"
                                      }
                                    },
                                    _vm._l(chapter.contents, function(
                                      content,
                                      j
                                    ) {
                                      return _c(
                                          ...
                                          [
                                            ...
                                            _c(
                                              "button",
                                              {
                                                ...
                                                on: {
                                                  click: function($event) {
                                                    return _vm.deleteCourseContent(
                                                      content
                                                    )
                                                  }
                                                }
          ...
          _vm.showModal
            ? [
                            ...
                            [
                              _c(
                                ...
                                [
                                                ...
                                                directives: [
                                                  {
                                                    ...
                                                    rawName: "v-model",
                                                    value:
                                                      _vm.editChapterContent
                                                        .chapter_id,
                                                    expression:
                                                      "editChapterContent.chapter_id"
                                                  }
                                                ],
                                                staticClass:
                                                ...
                                                directives: [
                                                  {
                                                    ...
                                                    value:
                                                      _vm.editChapterContent
                                                        .type,
                                                    expression:
                                                      "editChapterContent.type"
                                                  }
                                                ],
                                                staticClass:
                                                  "w-full form-control form-select",
                                                attrs: {
                                                  id: "e-attachment_type"
                                                },
                                                on: {
                                                  change: function($event) {
                                                    var $$selectedVal = Array.prototype.filter
                                  ...
                                  _vm._v(" "),
                                  _vm.editChapterContent.type === "VIDEO"
                                    ? [
                                        _c("div", { staticClass: "action" }, [
                                          _c(
                                            "div",
                                    ...
                                    : _vm._e(),
                                  _vm._v(" "),
                                  _vm.editChapterContent.type === "FILE"
                                    ? [
                                        _c("div", { staticClass: "action" }, [
                                          _c(
                                            "div",
                                        ...
                                        ? _c(
                                            "button",
                                            {
                                              ...
                                              attrs: {
                                                type: "submit",
                                                id: "add-record",
                                                "data-type": _vm.modalType,
                                                "data-chapter":
                                                  _vm.contentChapterId
                                              },
                                              on: { click: _vm.storeContent }
                                            },
                                            [_c("span", [_vm._v("Add Record")])]
                                          )
                                        : _vm._e(),
                                      _vm._v(" "),
                                      _vm.isSpinner
                ...
                _vm._v(" "),
                _c("div", { staticClass: "fixed pin bg-80 z-20 opacity-75" })
              ]
            : _vm._e(),
          _vm._v(" "),
          _vm.showEditModal
                                        ...
                                        ? _c(
                                            "button",
                                            {
                                              ...
                                              attrs: {
                                                ...
                                                "data-type": _vm.modalType,
                                                "data-contentId":
                                                  _vm.editChapterContent.id,
                                                "data-chapter":
                                                  _vm.editChapterContent
                                                    .chapter_id
                                              },
                                              on: { click: _vm.updateContent }
                                            },
                                            [
                                              _c("span", [
