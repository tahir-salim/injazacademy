...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sweetalert2__ = __webpack_require__(12);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getChaptersDetail: function getChaptersDetail() {
            var _this = this;

            this.courseId = this.$route.params.courseId;
            this.courseTitle = this.$route.params.courseTitle;
            // alert(this.courseId);
            Nova.request().get('/nova-vendor/manage-chapter/course/' + this.courseId).then(function (response) {
                _this.chapters = response.data.data.chapters;
                // if(response.data.data.course.type == "SCHEDULE_CONTENT"){
                //     this.isCourseSchedule = true;
                // }
                if (_this.chapters.length == 0) _this.chapterNotFound = true;else _this.chapterNotFound = false;
            ...
            __WEBPACK_IMPORTED_MODULE_1_sweetalert2___default.a.fire({
                ...
                if (result.value) {
                    Nova.request().post('/nova-vendor/manage-chapter/delete-chapter', {
                        ...
                        program_id: _this2.courseId
                    }).then(function (response) {
                        if (response) {

                            console.log(response);
                            _this2.showModal = false;
                            _this2.getChaptersDetail();
                            _this2.$toasted.show('Record has been Deleted!', { type: 'success' });
                        }
                    });
                }
            });
        },
        storeChapter: function storeChapter(e) {
            var _this3 = this;
            ...
            var submitBtn = document.getElementById("submitBtn"); // submit button for content type
            ...
            if (submitBtn.dataset.type == "new") {
                ...
                Nova.request().post('/nova-vendor/manage-chapter/add-chapter', {
                    ...
                    if (response) {
                        ...
                        _this3.getChaptersDetail();
                        _this3.$toasted.show('New Session has been Inserted!', { type: 'success' });
                    }
                });
            } else {
                ...
                Nova.request().post('/nova-vendor/manage-chapter/update-chapter', {
                    ...
                    if (response) {
                        ...
                        _this3.showModal = false;
                        _this3.getChaptersDetail();
                        _this3.$toasted.show('Session has been Updated!', { type: 'success' });
                    }
                });
            }
        },
        ...
        updateList: function updateList() {
            ...
            Nova.request().post('/nova-vendor/manage-chapter/update-chapter-series', {
                ...
                if (response) {
                    ...
                    _this4.getChaptersDetail();
                    _this4.$toasted.show('Record has been Updated!', { type: 'success' });
                }
            });
        },
        backToContent: function backToContent() {
            var url = '/dashboard/content-manager/' + this.courseId;
            window.location.href = url;
            console.log('Back');
        },
        capitalize: function capitalize(chapter) {
    ...
    [
      _c(
        "div",
        {
          ...
          staticStyle: { padding: "10px", width: "80%", margin: "0 auto" }
        },
        [
          _c(
            "div",
            ...
            [
              _c("h1", { staticClass: "mb-3 text-90 font-normal text-2xl" }, [
                _vm._v("Sessions Management - " + _vm._s(_vm.courseTitle))
              ])
            ]
          ),
          _vm._v(" "),
          _c("div", { staticClass: "flex items-center ml-auto px-3" }, [
            ...
            _c(
              "button",
              {
                staticClass: "btn btn-default btn-success custom-success-btn",
                staticStyle: { "margin-left": "10px" },
                on: {
                  click: function($event) {
                    return _vm.backToContent()
                  }
                }
              },
              [_vm._v("\n                    Back\n                ")]
                            ...
                            return _c("tr", [
                              ...
                              _c("td", [
                                _c("span", {
                                  staticClass: "whitespace-no-wrap text-left",
                                  domProps: {
                                    textContent: _vm._s(_vm.capitalize(chapter))
                                  }
                                })
                              ]),
                              _vm._v(" "),
                              _c(
                                "td",
                                { staticClass: "text-left pr-6 text-right" },
                                [
                                  _c(
                                    "button",
                                    {
                                      ...
                                      on: {
                                        click: function($event) {
                                          return _vm.editChapter(chapter)
                                        }
                                      }
                                    },
                                    [
                                  ...
                                  _c(
                                    "button",
                                    {
                                      ...
                                      on: {
                                        click: function($event) {
                                          return _vm.deleteChapter(chapter)
                                        }
                                      }
                                    },
                                    [
                              ...
                              [
                                ...
                                _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
                                  _c("input", {
                                    ...
                                    domProps: { value: _vm.chapterTitle },
                                    on: {
                                      input: function($event) {
                                        if ($event.target.composing) {
                                          return
                                        }
                                        _vm.chapterTitle = $event.target.value
                                      }
                                    }
                                  }),
                                  _vm._v(" "),
                            ...
                            _c(
                              ...
                              [
                                ...
                                _c(
                                  "div",
                                  {
                                    staticClass: "py-6 px-8 text-left",
                                ...
                                ? _c(
                                    "button",
                                    {
                                      ...
                                      attrs: {
                                        type: "submit",
                                        id: "submitBtn",
                                        "data-chapterId": _vm.chapterId,
                                        "data-type": _vm.modalType
                                      },
                                      on: { click: _vm.storeChapter }
                                    },
                                    [
                                      _c("span", [
                                        _vm._v(_vm._s(_vm.modalTitle))
