        ...
        <div v-cloak class="flex min-h-screen">
            ...
            <div class="flex-none pt-header min-h-screen w-sidebar bg-grad-sidebar px-6">
                <a href="{{ \Laravel\Nova\Nova::path() }}">
                    <div class="absolute pin-t pin-l pin-r bg-logo2 flex items-center w-sidebar h-header px-2 text-white">
                      <img style="max-width: 23%; margin-right:5px;" src="{{asset('images/icon1.png')}}" />
                      <h2 style="font-size: 16px;width: 50px;">{{env('APP_NAME')}}</h2>
